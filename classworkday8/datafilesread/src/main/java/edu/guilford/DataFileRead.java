...
public class DataFileRead {
    public static void main(String[] args) {
        ...
        // lets get a file name from the user and try to open the associated file
    ...
    public static void writeData(double[][] values, String location) throws URISyntaxException, IOException {
        // "throws" means "not our problem", its the problem of whoever asked us to run this method
        ...
        // Always close your files when your done so that you flush the buffer
        bufferWrite.close();
    }
